...
def generate_launch_description():
    ...
    teb_local_planner_params = os.path.join(costmap_params_dir, 'teb_local_planner_params.yaml')
    ...
    move_base = Node(
            ...
            node_name='move_base',
            output='screen',
            parameters=[{'base_local_planner': 'teb_local_planner/TebLocalPlannerROS'},
            ...
            arguments=[teb_local_planner_params, 'load']
        )
